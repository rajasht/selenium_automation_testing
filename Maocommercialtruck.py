...
class MAOcommercial:
    ...
    def execute(self):
        ...
        self.driver.get("https://qa.prod.commercialtrucktrader.com/listing/2022-TOYOTA-TACOMA-5022646131")
        timeLap()
        self.openMAOForm()
    ...
    def fillcategorie(self):
        categorie = self.driver.find_element(By.XPATH,
                                             "//body/div[@id='modalWindowsContainer']/div[@id='mytraderModal']/div[2]/div[1]/div[1]/div[1]/span[1]/div[1]/div[3]/div[1]/div[2]/div[1]/div[2]/div[1]/div[1]/div[1]/div[1]/div[1]/input[1]")

        categorie.send_keys(Keys.ARROW_DOWN * 3, Keys.ENTER)

    # year
    def fillYear(self):
        year = self.driver.find_element(By.XPATH, "//*[@id='vs3__combobox']/div[1]/input")
        year.click()
    ...
    # make
    def fillMake(self):
        make = self.driver.find_element(By.XPATH, "(//*[@id='input-field-make'])[1]")
        make.click()
        make.send_keys("hero")

    # modal
    def fillModal(self):
        modal = self.driver.find_element(By.XPATH, "(//*[@id='input-field-model'])[1]")
        modal.click()
...
if __name__ == '__main__':
    objMAOcommercial = MAOcommercial()
    objMAOcommercial.execute()
